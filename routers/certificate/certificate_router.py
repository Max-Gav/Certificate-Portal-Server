...
from models.certificate_route_models.certificate import BaseCertificate, EditCertificate
...
async def delete_certificate(certificate_id: str, payload: Annotated[
                             TokenPayload, Depends(AccessTokenUtils())]) -> str:
